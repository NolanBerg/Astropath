...
Astropath will be a streamlined, user-friendly astrophotography tool designed to simplify the creation of star trails and starlapses. Our goal is to deliver an application that enables users to batch import TIFF images, quickly select and deselect images for processing, and apply automated processing modes like gap filling, lighten, and darken to produce clean star trail effects.

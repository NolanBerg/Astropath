 ...
 */
{
  ...
  var { userAgent: z = "" } = c.navigator || {}, h = c, m = l;
  function s(c, l, z) {
    (l = ((c) =>
        "symbol" == typeof (c = ((c, l) => {
  ...
  var m = {
    ...
    H = { fakd: "kit-duotone", "fa-kit-duotone": "kit-duotone" },
    e = { kit: "fak" },
    L = { "kit-duotone": "fakd" },
  ...
  var r = v({}, m),
    t =
      (r[M] = v(v(v(v({}, { "fa-duotone": "duotone" }), m[M]), z), H),
        f(r),
        (m = v({}, {
          classic: {
            solid: "fas",
  ...
  function i(c, l, z) {
    var { skipHooks: z = !1 } = 2 < arguments.length && void 0 !== z ? z : {},
      h = o(l);
    "function" != typeof t.hooks.addPack || z
      ? t.styles[c] = v(v({}, t.styles[c] || {}), h)
      : t.hooks.addPack(c, o(l)), "fas" === c && i("fa", l);
  }
  var d = {
    monero: [
      496,
